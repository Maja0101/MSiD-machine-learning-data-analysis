...
class CustomLogisticRegression:
    ...
    def cross_entropy(self, l, y_true):
        ...
        return -np.sum(y_true * np.log(pred)) / y_true.shape[0]
    ...
    def fit(self, X, y, X_test=None, y_test=None):
        ...
        for epoch in range(self.epochs):
            ...
            for i in range(0, m, self.batch_size):
                ...
                # y_pred = self.softmax(X_batch @ self.W + self.b)
            ...
            # print("after:", self.W, self.b)

            logits_train = X @ self.W + self.b
            # y_pred_train = self.softmax(X @ self.W + self.b)
            ...
            if X_test is not None and y_test is not None:
                ...
                # y_pred_test = self.softmax(X_test @ self.W + self.b)
